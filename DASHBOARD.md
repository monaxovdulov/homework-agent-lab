...
| Позывной | Активные | Ждет ученика | В работе | Нужна помощь | Нужны правки | Ждет проверки | Зачтено | Issue |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `diogen` | 1 | 1 | 0 | 0 | 0 | 0 | 0 | [#1](https://github.com/monaxovdulov/homework-agent-lab/issues/1) |
| `sokrat` | 1 | 1 | 0 | 0 | 0 | 0 | 0 | [#2](https://github.com/monaxovdulov/homework-agent-lab/issues/2) |
...
_Сейчас нет домашних в статусе `статус:ждет-проверки 🔍`._
