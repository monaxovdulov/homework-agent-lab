...
```text
статус:ожидает        # домашка выдана, ученик еще не начал
статус:в-работе       # ученик взял домашку
статус:на-проверке    # ученик сдал через PR или комментарий
статус:нужны-правки   # учитель попросил исправления
статус:заблокировано  # нужен вопрос или уточнение
статус:готово         # учитель принял работу
```
