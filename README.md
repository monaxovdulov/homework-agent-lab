...
Это переводит Issue в `статус:на-проверке 🔎`. Закрывать Issue нужно только после
проверки учителем.
...
```text
статус:ожидает 🕰️        # домашка выдана, ученик еще не начал
статус:в-работе ⚙️       # ученик взял домашку
статус:на-проверке 🔎    # ученик сдал через PR или комментарий
